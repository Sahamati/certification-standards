Feature: On calling POST Consent Fetch API, verify that on responding with status PAUSED for consent fetch request,
  ...
  request is received in mock server. Set the consent fetch response with consent status as PAUSED.
